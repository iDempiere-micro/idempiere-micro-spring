...
public class MMovementConfirm extends X_M_MovementConfirm implements DocAction, IPODoc
{
    ...
    public CompleteActionResult completeIt()
    {
        ...
        setProcessed(true);
        saveEx();
        ProcessInfo processInfo = ServerProcessCtl.runDocumentActionWorkflow(move, DocAction.Companion.getACTION_Complete());
        ...
        if (m_inventoryInfo != null)
        {
            ...
            {
                processInfo = ServerProcessCtl.runDocumentActionWorkflow(inventory, DocAction.Companion.getACTION_Complete());
                if (processInfo.isError())
                {
                    m_processMsg = processInfo.getSummary();
                    setProcessed(false);
