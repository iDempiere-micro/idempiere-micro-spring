  ...
  protected String doIt() throws Exception {
    ...
    if (p_C_Invoice_ID != 0) sql.append("C_Invoice_ID=").append(p_C_Invoice_ID);
      ...
      if (p_DateInvoiced_From != null && p_DateInvoiced_To != null)
        ...
        sql.append(" AND TRUNC(DateInvoiced) >= ").append(DB.TO_DATE(p_DateInvoiced_From, true));
      else if (p_DateInvoiced_To != null)
        sql.append(" AND TRUNC(DateInvoiced) <= ").append(DB.TO_DATE(p_DateInvoiced_To, true));
    }
