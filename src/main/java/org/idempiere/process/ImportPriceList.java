          ...
          if (pricelist.save()) {
            ...
            StringBuilder sql0 =
                new StringBuilder("UPDATE I_PriceList i ")
                    ...
                    .append(DB.TO_STRING("Insert Price List failed"))
        ...
        if (newPriceListVersion) //	Insert new Price List Version
        {
          ...
          if (pricelistversion.save()) {
            ...
            StringBuilder sql0 =
                new StringBuilder("UPDATE I_PriceList i ")
                    .append("SET I_IsImported='E', I_ErrorMsg=I_ErrorMsg||")
                    .append(DB.TO_STRING("Insert Price List Version failed"))
                    .append("WHERE I_PriceList_ID=")
                    .append(I_PriceList_ID);
            DB.executeUpdate(sql0.toString(), get_TrxName());
            continue;
        ...
        if (imp.getC_BPartner_ID() > 0) {
          ...
          if (ppvb.save()) {
            ...
            StringBuilder sql0 =
                new StringBuilder("UPDATE I_PriceList i ")
                    .append("SET I_IsImported='E', I_ErrorMsg=I_ErrorMsg||")
                    .append(DB.TO_STRING("Insert/Update Product Price Vendor Break Version failed"))
                    .append("WHERE I_PriceList_ID=")
                    .append(I_PriceList_ID);
            DB.executeUpdate(sql0.toString(), get_TrxName());
            continue;
          ...
          if (pp.save()) {
            ...
            StringBuilder sql0 =
                new StringBuilder("UPDATE I_PriceList i ")
                    .append("SET I_IsImported='E', I_ErrorMsg=I_ErrorMsg||")
                    .append(DB.TO_STRING("Insert/Update Product Price failed"))
                    .append("WHERE I_PriceList_ID=")
                    .append(I_PriceList_ID);
            DB.executeUpdate(sql0.toString(), get_TrxName());
            continue;
