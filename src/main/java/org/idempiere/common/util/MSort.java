 ...
 *
 * <ul>
 *   <li>2007-01-27 - teo_sarca - [ 1585369 ] CTable sorting is TOO LAZY: Fixed {@link
 *       #compare(Object, Object)} method for Double comparing support, ascending/descending
 *       support, comparing strings ignoring case
 * </ul>
 *
 * @author Jorg Janke
...
public final class MSort implements Comparator<Object>, Serializable {
  ...
  public int compare(Object o1, Object o2) {
    ...
    Object cmp1 = o1;
    if (o1 instanceof MSort) cmp1 = ((MSort) o1).data;
    if (cmp1 instanceof NamePair) cmp1 = ((NamePair) cmp1).getName();

    Object cmp2 = o2;
    if (o2 instanceof MSort) cmp2 = ((MSort) o2).data;
    if (cmp2 instanceof NamePair) cmp2 = ((NamePair) cmp2).getName();

    //	Comparing Null values
    if (cmp1 == null) {
      if (cmp2 == null) return 0;
      return -1 * m_multiplier;
    }
    if (cmp2 == null) return 1 * m_multiplier;
