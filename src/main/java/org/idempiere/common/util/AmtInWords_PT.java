...
public class AmtInWords_PT implements AmtInWords {
  ...
  private String convertLessThanOneThousand(int number) {
    ...
    if (number % 100 < 20) {
      ...
      if (s.endsWith("2") && !soFar.equals("")) soFar = " Vinte e " + soFar.trim();
      else if (soFar.equals("")) soFar = tensNames[number % 10] + soFar;
      else soFar = tensNames[number % 10] + " e" + soFar;
      number /= 10;
    }
    if (number == 0)
      // return soFar;
  ...
  private String convert(BigDecimal number) {
    /* special case */
    if (number.compareTo(Env.ZERO) == 0) return "";
    if (number.compareTo(Env.ONE) == 0) return "Um";
    if (number.compareTo(Env.ONE.negate()) == 0) return "Menos Um";
    String prefix = "";
    ...
    return (prefix + soFar).replaceAll(" e Mil", " Mil").trim();
  } //	convert
  ...
  public String getAmtInWords(String amount) throws Exception {
        ...
        if (valor > 0 && valor < 1) {
          if (Integer.parseInt(cents) > 0) {
            if (Integer.parseInt(cents) > 1) {
              sb.append(convert(new BigDecimal(cents))).append(" Centavos");
            } else {
              sb.append(convert(new BigDecimal(cents))).append(" Centavo");
            }
          }
          ...
          if (!cents.equals("") && Integer.parseInt(cents) > 0) {
            ...
            if (reais.abs().compareTo(Env.ONE) == 0) sb.append(" Real");
            else sb.append(" Reais");
          }
        }
      }
    }
    ...
    if (result.indexOf("Quinquilh") > 0
        && result.indexOf("Quatrilh") > 0
        && result.indexOf("Quatrilh\u00f5es de Rea") == -1
        && result.indexOf("Quatrilh\u00e3o de Rea") == -1)
      result =
          result
              .replaceAll("Quinquilh\u00f5es e", "Quinquilh\u00f5es,")
              .replaceAll("Quinquilh\u00e3o e", "Quinquilh\u00e3o,");

    if (result.indexOf("Quatrilh") > 0
        && result.indexOf("Trilh") > 0
        && result.indexOf("Trilh\u00f5es de Rea") == -1
        && result.indexOf("Trilh\u00e3o de Rea") == -1)
      result =
          result
              .replaceAll("Quatrilh\u00f5es e", "Quatrilh\u00f5es,")
              .replaceAll("Quatrilh\u00e3o e", "Quatrilh\u00e3o,");

    if (result.indexOf("Trilh") > 0
        && result.indexOf("Bilh") > 0
        && result.indexOf("Bilh\u00f5es de Rea") == -1
        && result.indexOf("Bilh\u00e3o de Rea") == -1)
      result =
          result
              .replaceAll("Trilh\u00f5es e", "Trilh\u00f5es,")
              .replaceAll("Trilh\u00e3o e", "Trilh\u00e3o,");

    if (result.indexOf("Bilh") > 0
        && result.indexOf("Milh") > 0
        && result.indexOf("Milh\u00f5es de Rea") == -1
        && result.indexOf("Milh\u00e3o de Rea") == -1)
      result =
          result
              .replaceAll("Bilh\u00f5es e", "Bilh\u00f5es,")
              .replaceAll("Bilh\u00e3o e", "Bilh\u00e3o,");

    if (result.indexOf("Milh") > 0
        && result.indexOf(" de Rea") == -1
        && result.indexOf("Mil e") > 0)
      result =
          result
              .replaceAll("Milh\u00f5es e", "Milh\u00f5es,")
              .replaceAll("Milh\u00e3o e", "Milh\u00e3o,");
