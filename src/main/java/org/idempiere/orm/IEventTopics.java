...
public interface IEventTopics {
  ...
  public static final String PO_AFTER_NEW_REPLICATION =
      MODEL_EVENT_PREFIX + "afterNewReplication"; // @Trifon
  ...
  public static final String PO_AFTER_CHANGE_REPLICATION =
      MODEL_EVENT_PREFIX + "afterChangeReplication"; // @Trifon
  ...
  public static final String PO_BEFORE_DELETE_REPLICATION =
      MODEL_EVENT_PREFIX + "beforeDeleteReplication"; // @Trifon
