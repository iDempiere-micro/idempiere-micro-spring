...
public class MUOMConversion extends X_C_UOM_Conversion
{
		...
		int M_Product_ID, int C_UOM_To_ID)
	{
		...
		List<MUOMConversion> conversions = new Query(ctx, I_C_UOM_Conversion.Table_Name, "C_UOM_ID=? AND C_UOM_TO_ID=?", null)
	...
	static public MUOMConversion[] getProductConversions (Properties ctx, int M_Product_ID)
	{
		...
		List<MUOMConversion> conversions = new Query(ctx, I_C_UOM_Conversion.Table_Name, whereClause, null)
	...
	private static final CCache<Integer,MUOMConversion[]>	s_conversionProduct 
		= new CCache<Integer,MUOMConversion[]>(I_C_UOM_Conversion.Table_Name, I_C_UOM_Conversion.Table_Name+"_Of_Product", 20);
	...
	protected boolean beforeSave (boolean newRecord)
	{
		...
		//	Enforce Product UOM
		if (MSysConfig.getBooleanValue(MSysConfig.ProductUOMConversionUOMValidate, true, getADClientID()))
		{
		...
		if (MSysConfig.getBooleanValue(MSysConfig.ProductUOMConversionRateValidate, true, getADClientID()))
		{
