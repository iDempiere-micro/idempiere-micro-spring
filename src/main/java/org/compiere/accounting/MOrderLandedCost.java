...
public class MOrderLandedCost extends X_C_OrderLandedCost {
	...
	{
		StringBuilder whereClause = new StringBuilder(I_C_OrderLandedCost.COLUMNNAME_C_Order_ID).append("=?");
	...
	{
		StringBuilder whereClauseFinal = new StringBuilder(I_C_OrderLandedCost.COLUMNNAME_C_OrderLandedCost_ID).append("=?");
