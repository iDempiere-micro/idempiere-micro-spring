...
public class MCost extends X_M_Cost
{
	...
	{
		final String whereClause = "AD_Client_ID=? AND AD_Org_ID=?"
									+" AND "+ I_M_Cost.COLUMNNAME_M_Product_ID+"=?"
									+" AND "+ I_M_Cost.COLUMNNAME_M_CostType_ID+"=?"
									+" AND "+ I_M_Cost.COLUMNNAME_C_AcctSchema_ID+"=?"
									+" AND "+ I_M_Cost.COLUMNNAME_M_CostElement_ID+"=?"
									+" AND "+ I_M_Cost.COLUMNNAME_M_AttributeSetInstance_ID+"=?";
	...
	protected boolean beforeSave (boolean newRecord)
	{
		...
		if (ce!=null && (ce.isAveragePO() || ce.isAverageInvoice()) && is_ValueChanged(I_M_Cost.COLUMNNAME_CurrentQty))
		{
