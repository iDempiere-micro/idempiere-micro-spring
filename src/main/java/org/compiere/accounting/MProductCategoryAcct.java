...
public class MProductCategoryAcct extends X_M_Product_Category_Acct
{
	...
	s_cache = new CCache<String, MProductCategoryAcct>(I_M_Product_Category_Acct.Table_Name, 40, 5);
							...
							int M_Product_Category_ID, int C_AcctSchema_ID, String trxName)
	{
		...
		acct = new Query(ctx, I_M_Product_Category_Acct.Table_Name, whereClause, trxName)
