...
public class MOrderLandedCostAllocation extends X_C_OrderLandedCostAllocation {
	...
	{
		StringBuilder whereClause = new StringBuilder(I_C_OrderLandedCostAllocation.COLUMNNAME_C_OrderLine_ID).append("=?");
	...
	public void setClientOrg(int a, int b) { super.setClientOrg(a, b); }
}
