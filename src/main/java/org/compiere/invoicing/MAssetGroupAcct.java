	...
	implements UseLife
{
	...
	{
		return new Query(ctx, I_A_Asset_Group_Acct.Table_Name, I_A_Asset_Group_Acct.COLUMNNAME_A_Asset_Group_ID+"=?", null)
	...
	{
		final String whereClause = I_A_Asset_Group_Acct.COLUMNNAME_A_Asset_Group_ID+"=? AND "+ I_A_Asset_Group_Acct.COLUMNNAME_PostingType+"=?";
	...
	*/
	...
	public MAssetGroupAcct copy(MAssetGroup grp)
	{
		...
		PO.copyValues(this, newAcct, grp.getAD_Client_ID(), grp.getAD_Org_ID());
