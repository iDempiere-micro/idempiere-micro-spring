...
// @M_Locator_ID@
    ...
    {
      POInfo poi = POInfo.getPOInfo (ctx, I_M_ProductionLine.Table_ID, get_TrxName());
      return poi;
    }
	...
	public void setM_AttributeSetInstance_ID (int M_AttributeSetInstance_ID)
	{
		if (M_AttributeSetInstance_ID < 0) 
			...
			set_Value (I_M_ProductionLine.COLUMNNAME_M_AttributeSetInstance_ID, Integer.valueOf(M_AttributeSetInstance_ID));
	}
	...
	{
		if (M_Locator_ID < 1) 
			set_Value (I_M_ProductionLine.COLUMNNAME_M_Locator_ID, null);
		else 
			set_Value (I_M_ProductionLine.COLUMNNAME_M_Locator_ID, Integer.valueOf(M_Locator_ID));
	}
	...
	{
		if (M_Product_ID < 1) 
			set_Value (I_M_ProductionLine.COLUMNNAME_M_Product_ID, null);
		else 
			set_Value (I_M_ProductionLine.COLUMNNAME_M_Product_ID, Integer.valueOf(M_Product_ID));
	}
	...
	public void setM_Production_ID (int M_Production_ID)
	{
		if (M_Production_ID < 1) 
			set_ValueNoCheck (I_M_ProductionLine.COLUMNNAME_M_Production_ID, null);
		else 
			set_ValueNoCheck (I_M_ProductionLine.COLUMNNAME_M_Production_ID, Integer.valueOf(M_Production_ID));
	}
	...
	public void setM_ProductionLine_ID (int M_ProductionLine_ID)
	{
		if (M_ProductionLine_ID < 1) 
			...
			set_ValueNoCheck (I_M_ProductionLine.COLUMNNAME_M_ProductionLine_ID, Integer.valueOf(M_ProductionLine_ID));
	}
	...
	public void setM_ProductionPlan_ID (int M_ProductionPlan_ID)
	{
		if (M_ProductionPlan_ID < 1) 
			...
			set_ValueNoCheck (I_M_ProductionLine.COLUMNNAME_M_ProductionPlan_ID, Integer.valueOf(M_ProductionPlan_ID));
	}
