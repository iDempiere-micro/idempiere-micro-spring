...
public class MRequest extends X_R_Request
{
	...
	public void setDueType()
	{
		...
		if (now.before(due))
			DueType = X_R_Request.DUETYPE_Scheduled;
		else if (now.after(overdue))
			DueType = X_R_Request.DUETYPE_Overdue;
	...
	public MRequestUpdate[] getUpdates(String confidentialType)
	{
		...
		for (MRequestUpdate ru : listUpdates)
		{
			if (confidentialType != null)
			{
				...
				if (ru.getConfidentialTypeEntry().equals(X_R_Request.CONFIDENTIALTYPEENTRY_PrivateInformation)
				...
				if (ru.getConfidentialTypeEntry().equals(X_R_Request.CONFIDENTIALTYPEENTRY_PartnerConfidential)
						&& confidentialType.equals(X_R_Request.CONFIDENTIALTYPEENTRY_PublicInformation))
					continue;
			}
			list.add(ru);
	...
	{
		return MRefList.getListName(getCtx(), X_R_Request.PRIORITYUSER_AD_Reference_ID, getPriorityUser());
	}	//	getPriorityUserText
	...
	{
		return MRefList.getListName(getCtx(), X_R_Request.CONFIDENTIALTYPE_AD_Reference_ID, getConfidentialType());
	}	//	getConfidentialText
	...
	{
		return MRefList.getListName(getCtx(), X_R_Request.CONFIDENTIALTYPEENTRY_AD_Reference_ID, getConfidentialTypeEntry());
	...
	public void setConfidentialTypeEntry (String ConfidentialTypeEntry)
	{
		...
		else if (X_R_Request.CONFIDENTIALTYPE_PrivateInformation.equals(getConfidentialType()))
		{
			if (X_R_Request.CONFIDENTIALTYPE_Internal.equals(ConfidentialTypeEntry)
				...
				super.setConfidentialTypeEntry (X_R_Request.CONFIDENTIALTYPE_PrivateInformation);
		}
		else if (X_R_Request.CONFIDENTIALTYPE_PartnerConfidential.equals(getConfidentialType()))
		{
			if (X_R_Request.CONFIDENTIALTYPE_Internal.equals(ConfidentialTypeEntry)
				...
				super.setConfidentialTypeEntry (X_R_Request.CONFIDENTIALTYPE_PartnerConfidential);
		}
...
*/
	...
	public void doEscalate(boolean user)
	{
		if (user)
		{
			...
			if (X_R_Request.PRIORITYUSER_Urgent.equals(Importance))
				;	//	high as it goes
		...
		else
		{
			...
			if (X_R_Request.PRIORITY_Urgent.equals(Importance))
				;	//	high as it goes
			...
			else if (X_R_Request.PRIORITY_Minor.equals(Importance))
				setPriority(X_R_Request.PRIORITY_Low);
		}
	}	//	doEscalate
