...
public class MGoal extends X_PA_Goal
{
	...
	public static BigDecimal getMultiplier (MGoal goal)
	{
		...
		if (MeasureScope.equals(X_PA_Goal.MEASURESCOPE_Total)
			||  MeasureDisplay.equals(X_PA_Goal.MEASUREDISPLAY_Total))
			return null;		//	Error
	...
	public String getMeasureDisplay ()
	{
		...
		if (s == null)
		{
			if (X_PA_Goal.MEASURESCOPE_Week.equals(getMeasureScope()))
				s = X_PA_Goal.MEASUREDISPLAY_Week;
			else if (X_PA_Goal.MEASURESCOPE_Day.equals(getMeasureScope()))
				s = X_PA_Goal.MEASUREDISPLAY_Day;
			else
				s = X_PA_Goal.MEASUREDISPLAY_Month;
		}
		return s;
	}	//	getMeasureDisplay
	...
	public String getXAxisText ()
	{
		...
		String display = MRefList.getListName(getCtx(), X_PA_Goal.MEASUREDISPLAY_AD_Reference_ID, value);
