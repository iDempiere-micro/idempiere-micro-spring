...
public class X_C_Conversion_Rate extends PO implements I_C_Conversion_Rate, I_Persistent
{
	...
	public void setC_Conversion_Rate_ID (int C_Conversion_Rate_ID)
	{
		if (C_Conversion_Rate_ID < 1) 
			...
			set_ValueNoCheck (I_C_Conversion_Rate.COLUMNNAME_C_Conversion_Rate_ID, Integer.valueOf(C_Conversion_Rate_ID));
	}
	...
	public void setC_ConversionType_ID (int C_ConversionType_ID)
	{
		if (C_ConversionType_ID < 1) 
			...
			set_Value (I_C_Conversion_Rate.COLUMNNAME_C_ConversionType_ID, Integer.valueOf(C_ConversionType_ID));
	}
	...
	{
		if (C_Currency_ID < 1) 
			set_Value (I_C_Conversion_Rate.COLUMNNAME_C_Currency_ID, null);
		else 
			set_Value (I_C_Conversion_Rate.COLUMNNAME_C_Currency_ID, Integer.valueOf(C_Currency_ID));
	}
