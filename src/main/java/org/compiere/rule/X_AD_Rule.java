...
// @SQL=select get_sysconfig('DEFAULT_ENTITYTYPE','U',0,0) from dual
    ...
    {
      POInfo poi = POInfo.getPOInfo (ctx, I_AD_Rule.Table_ID, get_TrxName());
      return poi;
    }
	...
	{
		if (AD_Rule_ID < 1) 
			set_ValueNoCheck (I_AD_Rule.COLUMNNAME_AD_Rule_ID, null);
		else 
			set_ValueNoCheck (I_AD_Rule.COLUMNNAME_AD_Rule_ID, Integer.valueOf(AD_Rule_ID));
	}
