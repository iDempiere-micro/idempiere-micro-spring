...
public class MProcessPara extends X_AD_Process_Para {
  ...
  public void loadLookup() {
    ...
    //
    if (m_lookup != null) m_lookup.loadComplete();
  } //  loadLookup
  ...
  public Lookup getLookup() {
    if (m_lookup == null && isLookup()) loadLookup();
    return m_lookup;
  } //	getLookup
  ...
  public String getReferenceTableName() {
    ...
    } else if (DisplayType.Table == getAD_Reference_ID()
        || DisplayType.Search == getAD_Reference_ID()) {
