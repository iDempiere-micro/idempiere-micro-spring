...
public class MSchedule extends X_AD_Schedule 
{
        ...
        //		Set Schedule Type & Frequencies
			if (X_AD_Schedule.SCHEDULETYPE_Frequency.equals(getScheduleType()))
			{
				if (getFrequencyType() == null)
					setFrequencyType(X_AD_Schedule.FREQUENCYTYPE_Day);
				if (getFrequency() < 1)
					setFrequency(1);
				setCronPattern(null);
			}
	...
	/**	Cache						*/
	private static CCache<Integer, MSchedule> s_cache = new CCache<Integer, MSchedule> (I_AD_Schedule.Table_Name, 10);
