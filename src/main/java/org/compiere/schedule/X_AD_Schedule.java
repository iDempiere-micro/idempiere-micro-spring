...
// N
	...
	{
		if (AD_Schedule_ID < 1) 
			set_ValueNoCheck (I_AD_Schedule.COLUMNNAME_AD_Schedule_ID, null);
		else 
			set_ValueNoCheck (I_AD_Schedule.COLUMNNAME_AD_Schedule_ID, Integer.valueOf(AD_Schedule_ID));
	}
	...
	{
		set_Value (I_AD_Schedule.COLUMNNAME_IsIgnoreProcessingTime, Boolean.valueOf(IsIgnoreProcessingTime));
	}
