...
public class MPriceList extends X_M_PriceList
{
	...
	public static MPriceList getDefault (Properties ctx, boolean IsSOPriceList)
	{
		...
		retValue = new Query(ctx, I_M_PriceList.Table_Name, whereClause, null)
	...
	private static CCache<Integer,MPriceList> s_cache = new CCache<Integer,MPriceList>(I_M_PriceList.Table_Name, 5, 5);
