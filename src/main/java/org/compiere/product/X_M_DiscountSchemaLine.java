...
public class X_M_DiscountSchemaLine extends PO implements I_M_DiscountSchemaLine, I_Persistent {
   ...
   *
   * @param Limit_Discount Discount in percent to be subtracted from base, if negative it will be
   *     added to base price
   */
   ...
   *
   * @return Discount in percent to be subtracted from base, if negative it will be added to base
   *     price
   */
  ...
  public void setM_DiscountSchemaLine_ID(int M_DiscountSchemaLine_ID) {
    if (M_DiscountSchemaLine_ID < 1) set_ValueNoCheck(COLUMNNAME_M_DiscountSchemaLine_ID, null);
    else
      set_ValueNoCheck(
          COLUMNNAME_M_DiscountSchemaLine_ID, Integer.valueOf(M_DiscountSchemaLine_ID));
  }
