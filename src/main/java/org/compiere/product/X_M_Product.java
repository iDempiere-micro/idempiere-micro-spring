...
// I
    ...
    {
      POInfo poi = POInfo.getPOInfo (ctx, I_M_Product.Table_ID, get_TrxName());
      return poi;
    }
	...
	public void setC_RevenueRecognition_ID (int C_RevenueRecognition_ID)
	{
		if (C_RevenueRecognition_ID < 1) 
			...
			set_Value (I_M_Product.COLUMNNAME_C_RevenueRecognition_ID, Integer.valueOf(C_RevenueRecognition_ID));
	}
	...
	public void setC_SubscriptionType_ID (int C_SubscriptionType_ID)
	{
		if (C_SubscriptionType_ID < 1) 
			set_Value (I_M_Product.COLUMNNAME_C_SubscriptionType_ID, null);
		else 
			set_Value (I_M_Product.COLUMNNAME_C_SubscriptionType_ID, Integer.valueOf(C_SubscriptionType_ID));
	}
	...
	public void setC_TaxCategory_ID (int C_TaxCategory_ID)
	{
		if (C_TaxCategory_ID < 1) 
			set_Value (I_M_Product.COLUMNNAME_C_TaxCategory_ID, null);
		else 
			set_Value (I_M_Product.COLUMNNAME_C_TaxCategory_ID, Integer.valueOf(C_TaxCategory_ID));
	}
	...
	{
		if (C_UOM_ID < 1) 
			set_Value (I_M_Product.COLUMNNAME_C_UOM_ID, null);
		else 
			set_Value (I_M_Product.COLUMNNAME_C_UOM_ID, Integer.valueOf(C_UOM_ID));
	}
	...
	{
		set_Value (I_M_Product.COLUMNNAME_IsPickListPrintDetails, Boolean.valueOf(IsPickListPrintDetails));
	}
	...
	public void setM_AttributeSet_ID (int M_AttributeSet_ID)
	{
		if (M_AttributeSet_ID < 0) 
			set_Value (I_M_Product.COLUMNNAME_M_AttributeSet_ID, null);
		else 
			set_Value (I_M_Product.COLUMNNAME_M_AttributeSet_ID, Integer.valueOf(M_AttributeSet_ID));
	}
	...
	public void setM_AttributeSetInstance_ID (int M_AttributeSetInstance_ID)
	{
		if (M_AttributeSetInstance_ID < 0) 
			...
			set_Value (I_M_Product.COLUMNNAME_M_AttributeSetInstance_ID, Integer.valueOf(M_AttributeSetInstance_ID));
	}
	...
	public void setM_FreightCategory_ID (int M_FreightCategory_ID)
	{
		if (M_FreightCategory_ID < 1) 
			set_Value (I_M_Product.COLUMNNAME_M_FreightCategory_ID, null);
		else 
	...
	{
		if (M_Locator_ID < 1) 
			set_Value (I_M_Product.COLUMNNAME_M_Locator_ID, null);
		else 
			set_Value (I_M_Product.COLUMNNAME_M_Locator_ID, Integer.valueOf(M_Locator_ID));
	}
	...
	{
		if (M_PartType_ID < 1) 
			set_Value (I_M_Product.COLUMNNAME_M_PartType_ID, null);
		else 
			set_Value (I_M_Product.COLUMNNAME_M_PartType_ID, Integer.valueOf(M_PartType_ID));
	}
	...
	public void setM_Product_Category_ID (int M_Product_Category_ID)
	{
		if (M_Product_Category_ID < 1) 
			set_Value (I_M_Product.COLUMNNAME_M_Product_Category_ID, null);
		else 
			set_Value (I_M_Product.COLUMNNAME_M_Product_Category_ID, Integer.valueOf(M_Product_Category_ID));
	}
	...
	{
		if (M_Product_ID < 1) 
			set_ValueNoCheck (I_M_Product.COLUMNNAME_M_Product_ID, null);
		else 
			set_ValueNoCheck (I_M_Product.COLUMNNAME_M_Product_ID, Integer.valueOf(M_Product_ID));
	}
	...
	{
		if (R_MailText_ID < 1) 
			set_Value (I_M_Product.COLUMNNAME_R_MailText_ID, null);
		else 
			set_Value (I_M_Product.COLUMNNAME_R_MailText_ID, Integer.valueOf(R_MailText_ID));
	}
	...
	{
		if (SalesRep_ID < 1) 
			set_Value (I_M_Product.COLUMNNAME_SalesRep_ID, null);
		else 
			set_Value (I_M_Product.COLUMNNAME_SalesRep_ID, Integer.valueOf(SalesRep_ID));
	}
	...
	public void setS_ExpenseType_ID (int S_ExpenseType_ID)
	{
		if (S_ExpenseType_ID < 1) 
			set_ValueNoCheck (I_M_Product.COLUMNNAME_S_ExpenseType_ID, null);
		else 
	...
	{
		if (S_Resource_ID < 1) 
			set_ValueNoCheck (I_M_Product.COLUMNNAME_S_Resource_ID, null);
		else 
			set_ValueNoCheck (I_M_Product.COLUMNNAME_S_Resource_ID, Integer.valueOf(S_Resource_ID));
	}
