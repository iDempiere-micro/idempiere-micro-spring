...
// N
	...
	public void setBPartner_Parent_ID (int BPartner_Parent_ID)
	{
		if (BPartner_Parent_ID < 1) 
			set_Value (I_C_BPartner.COLUMNNAME_BPartner_Parent_ID, null);
		else 
			set_Value (I_C_BPartner.COLUMNNAME_BPartner_Parent_ID, Integer.valueOf(BPartner_Parent_ID));
	}
	...
	{
		if (C_BPartner_ID < 1) 
			set_ValueNoCheck (I_C_BPartner.COLUMNNAME_C_BPartner_ID, null);
		else 
			set_ValueNoCheck (I_C_BPartner.COLUMNNAME_C_BPartner_ID, Integer.valueOf(C_BPartner_ID));
	}
	...
	{
		if (C_BP_Group_ID < 1) 
			set_Value (I_C_BPartner.COLUMNNAME_C_BP_Group_ID, null);
		else 
			set_Value (I_C_BPartner.COLUMNNAME_C_BP_Group_ID, Integer.valueOf(C_BP_Group_ID));
	}
	...
	{
		if (C_Dunning_ID < 1) 
			set_Value (I_C_BPartner.COLUMNNAME_C_Dunning_ID, null);
		else 
			set_Value (I_C_BPartner.COLUMNNAME_C_Dunning_ID, Integer.valueOf(C_Dunning_ID));
	}
	...
	{
		if (C_Greeting_ID < 1) 
			set_Value (I_C_BPartner.COLUMNNAME_C_Greeting_ID, null);
		else 
			set_Value (I_C_BPartner.COLUMNNAME_C_Greeting_ID, Integer.valueOf(C_Greeting_ID));
	}
	...
	public void setC_InvoiceSchedule_ID (int C_InvoiceSchedule_ID)
	{
		if (C_InvoiceSchedule_ID < 1) 
			set_Value (I_C_BPartner.COLUMNNAME_C_InvoiceSchedule_ID, null);
		else 
			set_Value (I_C_BPartner.COLUMNNAME_C_InvoiceSchedule_ID, Integer.valueOf(C_InvoiceSchedule_ID));
	}
	...
	public void setC_PaymentTerm_ID (int C_PaymentTerm_ID)
	{
		if (C_PaymentTerm_ID < 1) 
			set_Value (I_C_BPartner.COLUMNNAME_C_PaymentTerm_ID, null);
		else 
			set_Value (I_C_BPartner.COLUMNNAME_C_PaymentTerm_ID, Integer.valueOf(C_PaymentTerm_ID));
	}
	...
	{
		if (C_TaxGroup_ID < 1) 
			set_Value (I_C_BPartner.COLUMNNAME_C_TaxGroup_ID, null);
		else 
			set_Value (I_C_BPartner.COLUMNNAME_C_TaxGroup_ID, Integer.valueOf(C_TaxGroup_ID));
	}
    ...
    {
		return (I_C_1099Box)MTable.get(getCtx(), I_C_1099Box.Table_Name)
	...
	public void setDefault1099Box_ID (int Default1099Box_ID)
	{
		if (Default1099Box_ID < 1) 
			set_Value (I_C_BPartner.COLUMNNAME_Default1099Box_ID, null);
		else 
			set_Value (I_C_BPartner.COLUMNNAME_Default1099Box_ID, Integer.valueOf(Default1099Box_ID));
	}
	...
	public void setInvoice_PrintFormat_ID (int Invoice_PrintFormat_ID)
	{
		if (Invoice_PrintFormat_ID < 1) 
			set_Value (I_C_BPartner.COLUMNNAME_Invoice_PrintFormat_ID, null);
		else 
			set_Value (I_C_BPartner.COLUMNNAME_Invoice_PrintFormat_ID, Integer.valueOf(Invoice_PrintFormat_ID));
	}
	...
	{
		if (Logo_ID < 1) 
			set_Value (I_C_BPartner.COLUMNNAME_Logo_ID, null);
		else 
			set_Value (I_C_BPartner.COLUMNNAME_Logo_ID, Integer.valueOf(Logo_ID));
	}
	...
	public void setM_DiscountSchema_ID (int M_DiscountSchema_ID)
	{
		if (M_DiscountSchema_ID < 1) 
			set_Value (I_C_BPartner.COLUMNNAME_M_DiscountSchema_ID, null);
		else 
	...
	{
		if (M_PriceList_ID < 1) 
			set_Value (I_C_BPartner.COLUMNNAME_M_PriceList_ID, null);
		else 
			set_Value (I_C_BPartner.COLUMNNAME_M_PriceList_ID, Integer.valueOf(M_PriceList_ID));
	}
	...
	public void setPO_DiscountSchema_ID (int PO_DiscountSchema_ID)
	{
		if (PO_DiscountSchema_ID < 1) 
			set_Value (I_C_BPartner.COLUMNNAME_PO_DiscountSchema_ID, null);
		else 
			set_Value (I_C_BPartner.COLUMNNAME_PO_DiscountSchema_ID, Integer.valueOf(PO_DiscountSchema_ID));
	}
	...
	public void setPO_PaymentTerm_ID (int PO_PaymentTerm_ID)
	{
		if (PO_PaymentTerm_ID < 1) 
			set_Value (I_C_BPartner.COLUMNNAME_PO_PaymentTerm_ID, null);
		else 
			set_Value (I_C_BPartner.COLUMNNAME_PO_PaymentTerm_ID, Integer.valueOf(PO_PaymentTerm_ID));
	}
	...
	public void setPO_PriceList_ID (int PO_PriceList_ID)
	{
		if (PO_PriceList_ID < 1) 
			set_Value (I_C_BPartner.COLUMNNAME_PO_PriceList_ID, null);
		else 
			set_Value (I_C_BPartner.COLUMNNAME_PO_PriceList_ID, Integer.valueOf(PO_PriceList_ID));
	}
	...
	{
		if (SalesRep_ID < 1) 
			set_Value (I_C_BPartner.COLUMNNAME_SalesRep_ID, null);
		else 
			set_Value (I_C_BPartner.COLUMNNAME_SalesRep_ID, Integer.valueOf(SalesRep_ID));
	}
