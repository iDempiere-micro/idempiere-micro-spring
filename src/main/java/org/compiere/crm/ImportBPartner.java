	...
	protected void prepare()
	{
		...
		for (int i = 0; i < para.length; i++)
		{
			...
			if (name.equals("AD_Client_ID")) {
				...
				if (para1 instanceof BigDecimal) m_AD_Client_ID = ((BigDecimal) para[i].getParameter()).intValue();
            ...
            else if (name.equals("i_bPartner_Id"))
                i_bPartner_Id = para[i].getParameterAsInt();
			else
