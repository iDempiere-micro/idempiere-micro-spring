...
// .
	...
	public void setC_BPartner_ID (int C_BPartner_ID)
	{
		if (C_BPartner_ID < 1) 
			...
			set_ValueNoCheck (I_C_BPartner_Location.COLUMNNAME_C_BPartner_ID, Integer.valueOf(C_BPartner_ID));
	}
	...
	public void setC_BPartner_Location_ID (int C_BPartner_Location_ID)
	{
		if (C_BPartner_Location_ID < 1) 
			...
			set_ValueNoCheck (I_C_BPartner_Location.COLUMNNAME_C_BPartner_Location_ID, Integer.valueOf(C_BPartner_Location_ID));
	}
	...
	{
		if (C_Location_ID < 1) 
			set_Value (I_C_BPartner_Location.COLUMNNAME_C_Location_ID, null);
		else 
			set_Value (I_C_BPartner_Location.COLUMNNAME_C_Location_ID, Integer.valueOf(C_Location_ID));
	}
	...
	public void setC_SalesRegion_ID (int C_SalesRegion_ID)
	{
		if (C_SalesRegion_ID < 1) 
			...
			set_Value (I_C_BPartner_Location.COLUMNNAME_C_SalesRegion_ID, Integer.valueOf(C_SalesRegion_ID));
	}
