...
public class MMailText extends X_R_MailText
{
	...
	/** Translation Cache	*/
	private static CCache<String,MMailTextTrl> s_cacheTrl = new CCache<String,MMailTextTrl> (I_R_MailText.Table_Name, 20);
	...
	private String parseVariable (String variable, org.compiere.orm.PO po)
	{
		...
		// special default formatting cases for dates/times/boolean in mail text not covered by MSequence.parseVariable
