...
// @SQL=select get_sysconfig('DEFAULT_ENTITYTYPE','U',0,0) from dual
	...
	{
		if (AD_Role_ID < 0) 
			set_Value (I_AD_WF_Responsible.COLUMNNAME_AD_Role_ID, null);
		else 
			set_Value (I_AD_WF_Responsible.COLUMNNAME_AD_Role_ID, Integer.valueOf(AD_Role_ID));
	}
	...
	public void setAD_WF_Responsible_ID (int AD_WF_Responsible_ID)
	{
		if (AD_WF_Responsible_ID < 1) 
			...
			set_ValueNoCheck (I_AD_WF_Responsible.COLUMNNAME_AD_WF_Responsible_ID, Integer.valueOf(AD_WF_Responsible_ID));
	}
