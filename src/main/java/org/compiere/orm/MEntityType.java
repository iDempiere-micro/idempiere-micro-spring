...
public class MEntityType extends X_AD_EntityType
{
	...
	public static MEntityType get(Properties ctx, String entityType)
	{
		...
		if (retValue != null)
			return retValue;
		retValue = new Query(ctx, I_AD_EntityType.Table_Name, "EntityType=?", null)
	...
	/** Cached EntityTypes						*/
	private static CCache<String,MEntityType>	s_cache = new CCache<String,MEntityType>(I_AD_EntityType.Table_Name, 20);
	/**	Logger	*/
