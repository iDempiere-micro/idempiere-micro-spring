...
public class MSequence extends X_AD_Sequence
{
	...
	public static int getNextID (int AD_Client_ID, String TableName, String trxName)
	{
		...
		return MSequence.getNextIDImpl (AD_Client_ID, TableName, trxName); // it is ok to call deprecated method here
	}	//	getNextID
		...
		String TableName, boolean onlyDocType, String trxName)
	{
		...
		if (C_DocType_ID == 0)
		{
			if (s_log.isLoggable(Level.FINE)) s_log.fine("Window=" + WindowNo
	...
	public String getOrgColumn() {
		if (super.getOrgColumn() == null)
			return I_AD_Sequence.COLUMNNAME_AD_Org_ID;
		else
