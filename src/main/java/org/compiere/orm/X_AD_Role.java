...
public class X_AD_Role extends BasePOName implements I_AD_Role, I_Persistent {
   ...
   *
   * @param DaysApprovalAccum The days approval indicates the days to take into account to verify
   *     the accumulated approval amount.
   */
   ...
   * Set Master Role.
   *
   * @param IsMasterRole A master role cannot be assigned to users, it is intended to define access
   *     to menu option and documents and inherit to other roles
   */
