...
public class MRMALine extends X_M_RMALine implements I_M_RMALine
{
    ...
    {
        if ((m_ioLine == null || is_ValueChanged(I_M_RMALine.COLUMNNAME_M_InOutLine_ID)) && getM_InOutLine_ID() != 0)
    ...
    public boolean updateHeaderAmt()
    {
        ...
        if (isProcessed() && !is_ValueChanged(I_M_RMALine.COLUMNNAME_Processed))
            return true;
