...
public class X_M_ShippingTransaction extends PO implements I_M_ShippingTransaction, I_Persistent {
  ...
  public static final String
      DOTHAZARDCLASSORDIVISION_Class5_OxidizingSubstancesAndOrganicPeroxides = "5";
  /** 5.1 - Oxidizers = 5.1 */
  ...
  public static final String DOTHAZARDCLASSORDIVISION_Class6_ToxicPoisonousAndInfectiousSubstances =
      "6";
